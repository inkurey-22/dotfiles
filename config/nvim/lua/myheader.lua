...
function M.Epi_header()
  ...
  if not has_shebang then
    ...
    table.insert(hdr_lines, c.m .. " CURRY PROJECT, µYEARµ")
    ...
    table.insert(hdr_lines, s.m .. " CURRY PROJECT, µYEARµ")
...
function M.setup()
  ...
  vim.api.nvim_create_user_command('MyHeader', function() M.Epi_header() end, {})
end
