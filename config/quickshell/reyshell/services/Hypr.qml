...
Singleton {
    ...
    readonly property string kbLayout: kbMap.get(kbLayoutFull) ?? kbLayoutFull.slice(0, 2).toLowerCase()
    ...
    function reloadDynamicConfs(): void {
        extras.batchMessage(["keyword bindlni ,Caps_Lock,global,reyshell:refreshDevices", "keyword bindlni ,Num_Lock,global,reyshell:refreshDevices"]);
    }
