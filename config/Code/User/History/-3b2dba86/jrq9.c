...
{
    cr_assert_eq(my_strncmp(NULL, NULL, 5), 0);
}

Test(my_strncmp, s1_null)
{
    cr_assert_eq(my_strncmp(NULL, "abc", 2), -'a');
}

Test(my_strncmp, s2_null)
{
    cr_assert_eq(my_strncmp("abc", NULL, 2), 'a');
}