...
Test(my_islower, returns_1_for_lowercase)
{
    cr_assert_eq(my_islower('a'), 1);
    cr_assert_eq(my_islower('z'), 1);
    cr_assert_eq(my_islower('m'), 1);
}

Test(my_islower, returns_0_for_uppercase)
{
    cr_assert_eq(my_islower('A'), 0);
    cr_assert_eq(my_islower('Z'), 0);
}

Test(my_islower, returns_0_for_non_alpha)
{
    cr_assert_eq(my_islower('1'), 0);
    cr_assert_eq(my_islower('!'), 0);
    cr_assert_eq(my_islower(' '), 0);
