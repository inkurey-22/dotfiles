...
from reyshell.utils.paths import compute_hash, scheme_cache_dir, wallpaper_thumbnail_path
...
def get_score_for_image(image: Path | str, cache_base: Path):
    ...
    from reyshell.utils.material.score import score
...
def get_colours_for_image(image: Path | str = wallpaper_thumbnail_path, scheme=None) -> dict[str, str]:
    if scheme is None:
        from reyshell.utils.scheme import get_scheme
    ...
    from reyshell.utils.material.generator import gen_scheme
